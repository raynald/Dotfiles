...
globalkeys = awful.util.table.join(
    ...
    -- Move clients
    awful.key({ altkey }, "Next",  function () awful.client.moveresize( 5,  5, -10, -10) end),
    awful.key({ altkey }, "Prior", function () awful.client.moveresize(-5, -5,  10,  10) end),
    awful.key({ altkey }, "Down",  function () awful.client.moveresize(  0,  10,   0,   0) end),
    awful.key({ altkey }, "Up",    function () awful.client.moveresize(  0, -10,   0,   0) end),
    awful.key({ altkey }, "Left",  function () awful.client.moveresize(-10,   0,   0,   0) end),
    awful.key({ altkey }, "Right", function () awful.client.moveresize( 10,   0,   0,   0) end),
    ...
    awful.key({ modkey,        }, "g",      function () awful.util.spawn( "urxvt", false ) end),
